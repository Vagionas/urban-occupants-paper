...
build/~london-activity:
	python ./scripts/simulationinput.py ./build/seed.pickle ./build/markov-ts.pickle ./config/greater-london-activity.yaml build/sim-input-london-activity.db && python scripts/runsim.py build/energy-agents.jar build/sim-input-london-activity.db build/sim-output-london-activity.db config/greater-london-activity.yaml && python scripts/plot/simulationresultsaggregated-activity.py build/sim-output-london-activity.db config/greater-london-activity.yaml build/choropleth-london-activity-0200.png "2005-01-07 02:00:00" & python scripts/plot/simulationresultsaggregated-activity.py build/sim-output-london-activity.db config/greater-london-activity.yaml build/choropleth-london-activity-0400.png "2005-01-07 04:00:00" & python scripts/plot/simulationresultsaggregated-activity.py build/sim-output-london-activity.db config/greater-london-activity.yaml build/choropleth-london-activity-0800.png "2005-01-07 08:00:00" & python scripts/plot/simulationresultsaggregated-activity.py build/sim-output-london-activity.db config/greater-london-activity.yaml build/choropleth-london-activity-1000.png "2005-01-07 10:00:00" & python scripts/plot/simulationresultsaggregated-activity.py build/sim-output-london-activity.db config/greater-london-activity.yaml build/choropleth-london-activity-1200.png "2005-01-07 12:00:00" & python scripts/plot/simulationresultsaggregated-activity.py build/sim-output-london-activity.db config/greater-london-activity.yaml build/choropleth-london-activity-1400.png "2005-01-07 14:00:00" & python scripts/plot/simulationresultsaggregated-activity.py build/sim-output-london-activity.db config/greater-london-activity.yaml build/choropleth-london-activity-1600.png "2005-01-07 16:00:00" & python scripts/plot/simulationresultsaggregated-activity.py build/sim-output-london-activity.db config/greater-london-activity.yaml build/choropleth-london-activity-1800.png "2005-01-07 18:00:00" & python scripts/plot/simulationresultsaggregated-activity.py build/sim-output-london-activity.db config/greater-london-activity.yaml build/choropleth-london-activity-2000.png "2005-01-07 20:00:00" & python scripts/plot/simulationresultsaggregated-activity.py build/sim-output-london-activity.db config/greater-london-activity.yaml build/choropleth-london-activity-2200.png "2005-01-07 22:00:00" & python scripts/plot/simulationresultsaggregated-activity.py build/sim-output-london-activity.db config/greater-london-activity.yaml build/choropleth-london-activity-0000.png "2005-01-08 00:00:00"

build/thermal-power-london.png:
	python scripts/plot/simulationresultsaggregated.py build/sim-output-london-activity.db config/greater-london-activity.yaml build/choropleth-london-31-07.png build/thermal-power-london-31-07.png

build/choropleth-london-activity-we1200.png build/occupancy-london.png:
	python scripts/plot/simulationresultsaggregated-activity.py build/sim-output-london-activity.db config/greater-london-activity.yaml build/choropleth-london-activity-we1200.png build/occupancy-london.png "2005-01-08 12:00:00"

build/sim-output-econ-activity.db:
	python scripts/runsim.py build/energy-agents.jar build/sim-input-econ-activity.db build/sim-output-econ-activity.db config/econ-activity.yaml

build/choropleth-econ-activity-wd12.png build/occupancy-econ.png:
	python scripts/plot/simulationresults-activity.py build/sim-output-econ-activity.db config/econ-activity.yaml build/choropleth-econ-activity-wd12.png build/occupancy-econ.png "2005-01-07 12:00:00"